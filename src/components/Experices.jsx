    ...
    <div className="w-full h-screen flex flex-col justify-between">
        <div className="container px-4 m-auto">
            <div className="flex flex-col justify-center w-full py-8">
                ...
                <p className="section-header uppercase tracking-[10px] md:text-1xl text-sm my-text-gray">career path</p>
                </div>
                <p className="md:text-5xl text-4xl font-semibold text-center">Work Experices</p>
            </div>
        </div>
    </div>
  )
